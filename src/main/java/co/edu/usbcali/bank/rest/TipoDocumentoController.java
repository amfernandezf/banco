...
public class TipoDocumentoController {
	...
	public List<TipoDocumentoDTO> findAll(){
		List<TipoDocumento> tipoDocumentoList = tipoDocumentoService.findAll();
		List<TipoDocumentoDTO> tipoDocumentoListDTO = tipoDocumentoMapper.toTipoDocumentoDTOs(tipoDocumentoList);
